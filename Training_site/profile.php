...
<div class="container">
 ...
 //Recently added below codes - Binod
//// Displays Software skills from mysql database
//users are allow to edit their software skills
	echo '<div id="inputboxs" class="form-group">';
	echo '<label class="control-label col-sm-5" >Software Skills  :</label>';
	echo '<div class="col-sm-5">';
	echo '<input id="Software" type="skills" value= "'.$SoftwareSkills.'" disabled>';
	echo '<input id="softwareButton" type="button" value="Edit">';
	echo '<script> 
        			var sb = document.getElementById("softwareButton");
        			var so = document.getElementById("Software");
       				sb.addEventListener("click", function(){
						...
						$.ajax({
							type : "POST",
							url  : "saveprofile.php",
							data : {uid:'.$UID.', table:"user", item:"SoftwareSkills", value:so.value},
							success : function(data){
								//alert(data);
							}
						});
	...
	// Displays Hardware skills from mysql database
	// users are allow to edit their Hardware skills
	echo '<div id="inputboxs" class="form-group">';
	echo '<label class="control-label col-sm-5" >Hardware Skills :</label>';
	echo '<div class="col-sm-5">';
	echo '<input id="Hardware" type="name" value= "'.$HardwareSkill.'" disabled>';
	echo ' <input id="hardwareButton" type="button" value="Edit"> ';
	echo '<script> 
        			var hb = document.getElementById("hardwareButton");
        			var har = document.getElementById("Hardware");
       				hb.addEventListener("click", function(){
						...
						$.ajax({
							type : "POST",
							url  : "saveprofile.php",
							data : {uid:'.$UID.', table:"user", item:"HardwareSkill", value:har.value},
							success : function(data){
								//alert(data);
							}
						});
